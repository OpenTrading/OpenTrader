...
# Originally from:
# hg:/bitbucket.org/catherinedevlin/cmd2/ or
# https://pypi.python.org/packages/source/c/cmd2/cmd2-0.6.8.tar.gz
# Minor hacks and customizations to suit our purpose: nothing major.
...
class Cmd(cmd.Cmd):
    ...
    pythonStyleComment = pyparsing.Regex(r"^#.*").setName("Python style comment")
    commentGrammars = pyparsing.Or([pythonStyleComment, pyparsing.cStyleComment])
